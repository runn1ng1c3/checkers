...
public class Board {
	...
	public static boolean checkMovePossible(Cell cell, Cell[][] cells) {
		...
		if (cell.getType() == Type.BLACK) {
			...
			if (y == 0) {
				check = checkBorderPiece(cell, cells, 0);
			}

			else if (y == boardLength - 1) {
				check = checkBorderPiece(cell, cells, boardLength - 1);
			}

			else {
				// check to the right
				boolean rightCheck = checkLeftRightPiece(cell, cells, Direction.RIGHT);

				// check to the left
				boolean leftCheck = checkLeftRightPiece(cell, cells, Direction.LEFT);
	...
	public static boolean checkBorderPiece(Cell cell, Cell[][] cells, int border) {
	...
	public static boolean checkLeftRightPiece(Cell cell, Cell[][] cells, Direction dir) {
		boolean canMove = true;
		Type type = cell.getType();
		int x = cell.getX();
		int y = cell.getY();
	...
	public static void drawBoard(Cell[][] cells, int turn) {
		int redCount = 0;
		int blackCount = 0;
	...
	public static Direction getDirection(Scanner scanner, Cell cell, Cell[][] cells) {
		Direction dir = null;
		if (cell.getY() == 0 || !checkLeftRightPiece(cell, cells, Direction.LEFT)) {
			return dir = Direction.RIGHT;
		} else if (cell.getY() == boardLength - 1 || !checkLeftRightPiece(cell, cells, Direction.RIGHT)) {
